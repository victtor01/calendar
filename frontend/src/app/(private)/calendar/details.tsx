    ...
    >
      ...
      >
        ...
        <footer className="flex w-full  justify-end p-5">
          <motion.button className="dark:bg-white bg-zinc-950 hover:bg-indigo-600 hover:dark:bg-indigo-600 hover:text-white hover:dark:text-white text-gray-200 p-3 rounded px-4 dark:text-gray-700 text-lg font-bold opacity-90 hover:opacity-100">
            Terminar Evento
          </motion.button>
        </footer>
      </motion.section>
